"""
Base settings for the SaaS Platform.
"""
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.saas_core.context_processors.tenant_context',
            ],
        },
    },
]
...
# OWASP A09: Comprehensive Security & Application Logging
LOGGING = {
    'version': 1,
    ...
    'formatters': {
        ...
        'security': {
            'format': '[{asctime}] [SECURITY_AUDIT] {levelname} [{name}] {message}',
            'style': '{',
            'datefmt': '%Y-%m-%d %H:%M:%S',
        },
    },
